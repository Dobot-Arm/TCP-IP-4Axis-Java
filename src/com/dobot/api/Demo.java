...
public class Demo extends JFrame{
    ...
    public Demo(){
        ...
        movJButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Thread thread = new Thread(){
                    @Override
                    public void run(){
                        boolean flag = isDataTrue(XTextField.getText(),YTextField.getText(),ZTextField.getText(),RTextField.getText());
                        if(!flag){
                        ...
                        movJEntity.R = Integer.valueOf(RTextField.getText());
            ...
            public void actionPerformed(ActionEvent e) {
                Thread thread = new Thread(){
                    ...
                    public void run(){
                        ...
                        movLEntity.R = Integer.valueOf(RTextField.getText());
        ...
        JointMovJButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Thread thread = new Thread(){
                    @Override
                    public void run(){
                        boolean flag = isDataTrue(J1TextField.getText(),J2TextField.getText(),J3TextField.getText(),J4TextField.getText());
                        if(!flag){
        ...
        minusRButton.setBounds(feedbackLabel.getX()+240,minusZButton.getY()+50,40,30);
        ...
        feedbackRTextField = new JTextField("R:" + feedback.ToolVectorActual[3]);
        ...
        feedbackRTextField.setBounds(feedbackLabel.getX()+310,feedbackZTextField.getY()+50,80,30);
            ...
            public void run(){
                while(true){
                    try {
                        ...
                        feedbackRTextField.setText("R:" + df.format(feedback.ToolVectorActual[3]));
